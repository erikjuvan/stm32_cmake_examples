 ...
 * C/C++ source code generated on : Mon Nov 27 10:27:16 2023
 *
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__DaxisIgain = 5906.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__DaxisPgain = 25.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__QaxisIgain = 5906.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__QaxisPgain = 25.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IsMax = 5.5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IsMaxStartup = 5.5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__RPMnegative = -6000.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__RPMpositive = 6000.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Ld = 0.0062F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Lq = 0.0119F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Psi = 0.37F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Rs = 2.36F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_PowerLimit__MiddleLimit = 850.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_PowerLimit__UpperLimit = 950.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ObserverK1 = 168.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ObserverK2 = 199528.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__PLLBWSpeedSwitch = 1500.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__PLL_Bandwith = 40.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__PLL_BandwithReduction = 0.25F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ValidMinRPM = 150.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Dgain = 5.0E-5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Igain = 0.08F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Pgain = 0.006F;
