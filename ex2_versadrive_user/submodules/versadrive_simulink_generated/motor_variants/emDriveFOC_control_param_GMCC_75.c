...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg_Calculated__Bandwith = 400.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__DaxisIgain = 6886.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__DaxisPgain = 21.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__QaxisIgain = 6886.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_CurrentReg__QaxisPgain = 40.0F;
...
/*
   ...
   @@ END
 */
volatile boolean_T Ctrl_Limits_OverrideCloseLoopRamp = true;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IdMin = -4.3F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IqMax = 4.5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IsMax = 3.2F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__IsMaxStartup = 4.5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__RPMnegative = -8000.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Limits__RPMpositive = 8000.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__IronLossCoef = 1.08E-7F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Ld = 0.00838F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Lq = 0.01596F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Psi = 0.125F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Motor__Rs = 2.74F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_OpenLoop__Id = 2.5F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_PowerLimit__DisableLimit = 550.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_PowerLimit__MiddleLimit = 800.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ObserverK1 = 227.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ObserverK2 = 1.49652E+6F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__PLL_Bandwith = 50.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__TimeInHoldState = 0.2F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_Sensorless__ValidLPFtimeConstant = 0.0F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Igain = 0.03F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__IgainHigh = 0.01F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Igain_LoadMeas = 0.2F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Pgain = 0.002F;
...
/*
   ...
   @@ END
 */
volatile real32_T Ctrl_VelocityReg__Pgain_LoadMeas = 0.03F;
