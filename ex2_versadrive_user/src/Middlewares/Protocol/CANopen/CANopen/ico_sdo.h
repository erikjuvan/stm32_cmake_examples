...
/**
*@file   ico_sdo.h
*@brief  contains internal defines for SDO
...
RET_T	icoSdoClientCheckObjLimitCobId(UNSIGNED16 sdoNr, UNSIGNED8	subIndex,UNSIGNED32	canId);
...
void	    icoSdoClientQueueInd(UNSIGNED8	sdoNr, UNSIGNED16 index,UNSIGNED8 subIndex, UNSIGNED32	result);
